...
NODE_BODY_RECT_CLASSES = {"participant", "service", "store", "source", "process", "infra", "sink", "terminal", "io", "state", "passive", "transform", "usecase"}
...
def collect_node_polygons(root: ET.Element) -> list[list[tuple[float, float]]]:
    ...
    for rect in svg_elements(root, "rect"):
        if classes(rect) & NODE_BODY_RECT_CLASSES:
